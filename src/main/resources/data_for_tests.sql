...
INSERT INTO products (name, barcode, price, profit_margin, category_id, unit_type, is_perishable, min_quantity_in_stock) VALUES
('Arroz Tipo 1 5kg', '7891234567890', 25.90, 30.00, 1, 'COUNT', FALSE, 10),
('Feijão Preto 1kg', '7891234567891', 8.50, 35.00, 1, 'COUNT', FALSE, 15),
('Leite Integral 1L', '7891234567892', 5.99, 25.00, 2, 'COUNT', TRUE, 20),
('Iogurte Natural 170g', '7891234567893', 3.50, 40.00, 2, 'COUNT', TRUE, 12);

-- 5. Lotes (Agora vinculados a restock_id e supplier_id)
-- Colunas: product_id, supplier_id, restock_id, batch_code, expiration_date, original_quantity, quantity_in_stock, purchase_price
INSERT INTO batches (product_id, supplier_id, restock_id, batch_code, manufacture_date, expiration_date, original_quantity, quantity_in_stock, purchase_price) VALUES
...
('teste', '$2a$12$osiy5mvdV7RfOqs1wPgwbeYBrkCJ4C6XeL0/kZKwdsmBPmQVBYcOm', 'ROLE_MANAGER', TRUE);
